 ...
 * org.apache.bcel.verifier.structurals.InstConstraintVisitor. InstConstraintVisitor appears to be
 * quite out of date and incorrectly fails on many valid class files. Hence, StackVer assumes the
 * method is valid and is only interested in the result of the symbolic execution in order to
 * capture the state of the local variables and stack at the start of each byte code instruction.
 */
